  ...
  const features = [
    {
      ...
      desc: "Uluslararası standartta yapılandırılmış içerik"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="w-full bg-white py-12 md:py-20">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        {/* Section Title */}
        <h2 className="text-[32px] md:text-[42px] font-bold text-gray-900 text-center mb-12 md:mb-16">
          Neden Woody?
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
          {features.map((feature, index) => (
            <div key={index} className="flex items-start gap-5">
              ...
              <div 
                className="flex-shrink-0 w-16 h-16 md:w-18 md:h-18 rounded-full flex items-center justify-center text-white"
              ...
              <div className="flex-1 pt-1">
                <h3 className="text-[16px] md:text-[18px] font-bold text-gray-900 mb-2 leading-snug">
                  {feature.title}
                </h3>
