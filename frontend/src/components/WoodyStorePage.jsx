            ...
            {(category.id === 'atolye' || category.id === 'ozel-ders') ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                {category.products.map((product) => (
                  ...
                  >
                    {/* Product Image - aspect-[3/4] ile daha uzun */}
                    ...
                    <div className="p-3 md:p-4">
                      ...
                      {/* Fiyat + Teklif Al Butonu - Yan Yana */}
                      <div className="flex items-center justify-between gap-2">
                        {/* Fiyat */}
                        <p className="text-[13px] md:text-[14px] font-bold text-gray-800 flex-1">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-2 bg-[#FF6A00] hover:bg-[#E85C00] text-white text-[12px] md:text-[13px] font-medium rounded-lg transition-colors whitespace-nowrap"
                        >
