                    ...
                    <div className="p-3 md:p-4">
                      ...
                      <div className="mt-3">
                        <button
                          ...
                          className="flex items-center justify-center gap-1.5 px-4 py-2.5 bg-[#FF6A00] hover:bg-[#E85C00] text-white text-[12px] md:text-[13px] font-medium rounded-lg transition-colors w-full"
                        >
                          Teklif Al
                        </button>
                      </div>
