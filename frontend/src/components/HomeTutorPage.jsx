...
const HomeTutorPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Banner Strip */}
      <section className="w-full bg-gradient-to-r from-purple-400 via-purple-500 to-pink-400 py-4 shadow-md">
      ...
      <section className="w-full py-20 md:py-24 bg-white">
        <div className="max-w-[1100px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            >
              <div className="mb-6">
                <div className="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center mx-auto mb-5 group-hover:bg-blue-100 transition-colors">
            ...
            >
              <div className="mb-6">
                <div className="w-12 h-12 rounded-xl bg-purple-50 flex items-center justify-center mx-auto mb-5 group-hover:bg-purple-100 transition-colors">
            ...
            >
              <div className="mb-6">
                <div className="w-12 h-12 rounded-xl bg-green-50 flex items-center justify-center mx-auto mb-5 group-hover:bg-green-100 transition-colors">
