    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] overflow-hidden mt-[72px]">
        <div className="absolute inset-0">
          <img src="https://images.squarespace-cdn.com/content/v1/60241cb68df65b530cd84d95/22305642-e101-4a60-a871-45a6a6d12d44/ember_stills_sdr_0154933.tiff-0.jpg" alt="Woody Home & Tutor" className="w-full h-full object-cover" />
      ...
      <section className="w-full bg-white py-12 md:py-16">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          <div className="w-24 h-[3px] mx-auto mb-12" style={{ backgroundColor: '#9B59B6' }} />
