...
const CertificationSection = () => {
  return (
    <section className="w-full" style={{ paddingTop: '0px', paddingBottom: '0px', backgroundColor: '#FFFFFF' }}>
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p 
            ...
            style={{ marginBottom: '0px', lineHeight: '1.3' }}
          >
          ...
          {/* AKADEMİK İŞ BİRLİKLERİMİZ - HEMEN LOGO ÜSTÜNDE */}
          <p 
            className="text-[10px] md:text-[11px] text-gray-500 uppercase" 
            style={{ letterSpacing: '0.15em', marginTop: '6px', marginBottom: '0px', fontWeight: 500 }}
          >
            Akademik İş Birliklerimiz
          </p>

          {/* LOGOS - HEMEN ALTINDA, ARKA PLAN YOK */}
