...
const CertificationSection = () => {
  return (
    <section className="w-full" style={{ paddingTop: '60px', paddingBottom: '60px', backgroundColor: '#FFFFFF' }}>
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          {/* Small Text Above Logos - Increased Letter Spacing */}
          <p 
            className="text-[12px] md:text-[13px] text-gray-500 mb-8 uppercase" 
            style={{ letterSpacing: '0.2em' }}
          >
            Akademik İş Birliklerimiz
          </p>

          {/* Logos - Optimized Size & Spacing */}
          <div className="flex items-center justify-center gap-10 md:gap-12 lg:gap-14 flex-wrap">
            <img 
              src="https://customer-assets.emergentagent.com/job_render-studio-49/artifacts/0ljulhkj_8.png"
              alt="Cambridge English"
              className="h-[48px] md:h-[52px] lg:h-[56px] w-auto transition-opacity duration-300"
              style={{ opacity: 0.85 }}
