      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        ...
        >
          <div className="w-full lg:w-1/2">
            <div
              className={`overflow-hidden rounded-[20px] shadow-xl relative transition-all duration-500 bg-gray-50 ${section.id === 'preschool-series' ? 'group-hover/section:shadow-2xl group-hover/section:scale-[1.02]' : ''}`}
              style={{
            ...
            >
              <img src={section.image} alt={sectionT?.title || section.title} className="w-full h-full object-cover transition-transform duration-700 hover:scale-[1.03]" loading="lazy" />
            </div>
          </div>
