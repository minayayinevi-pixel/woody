    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] overflow-hidden mt-[72px]">
        <div className="absolute inset-0">
          ...
          >
            <source src="https://customer-assets.emergentagent.com/job_render-studio-49/artifacts/7ieerlri_1%20kopyas%C4%B1%20kopyas%C4%B1%20%28Video%29%20%281%29.mp4" type="video/mp4" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
          ...
          <p className="text-base md:text-lg text-white/90 text-center max-w-2xl leading-relaxed" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.7)' }}>
            Atölye serisiyle çocuklar, İngilizceyi sadece dinlemez; oynar, uygular ve yaşar. Woody ve Arkadaşları ile daha canlı ve etkili bir öğrenme süreci sunun.
          </p>
        </div>
