...
const PreschoolPage = () => {
  ...
  const levelVideos = {
    ...
    'Junior Level': {
      student: 'https://customer-assets.emergentagent.com/job_render-studio-49/artifacts/che2qlij_jun%C4%B1or%20o%CC%88g%CC%86renci.mp4',
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] overflow-hidden mt-[72px]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
          ...
          <p className="text-base md:text-lg text-white/90 text-center max-w-2xl leading-relaxed" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.7)' }}>
            Woody Okul Serisi, kurumlara oyun temelli, planlı ve sürdürülebilir bir İngilizce eğitim altyapısı sunar.
          </p>
        </div>
      ...
      {showVideo && (
        <div className="fixed inset-0 z-[100] bg-black/90 flex items-center justify-center p-4">
          ...
          <div className="w-full max-w-[1000px] aspect-video">
            {activeVideo === 'hero' ? (
              // Hero video için yüklenen MP4 video göster
              <video
              ...
              // Diğer videolar için iframe (Vimeo)
